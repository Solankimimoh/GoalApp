...
public class ExerciseInfoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        endTv = findViewById(R.id.activity_exercise_info_week_tv);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.activity_exercise_info_week_tv:
                chooseEndDate();
                break;
            case R.id.activity_exercise_info_start_tv:
                chooseStartDate();
                break;
            case R.id.activity_exercise_info_time_tv:
                chooseTime();
                break;
            case R.id.activity_exercise_setgoal_btn:
                setGoal();
                break;
    ...
    private void chooseTime() {
        ...
        timePickerDialog = new TimePickerDialog(ExerciseInfoActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    private void chooseStartDate() {
        ...
        datePickerDialog = new DatePickerDialog(ExerciseInfoActivity.this, new DatePickerDialog.OnDateSetListener() {
            @Override
