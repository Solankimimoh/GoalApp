...
public class SmokingInfoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        endTv = findViewById(R.id.activity_smoking_info_target_week_ed);
        startDateTv = findViewById(R.id.activity_smoking_info_start_tv);
        setGoalBtn = findViewById(R.id.activity_smoking_info_setgoal_btn);
    ...
    private void chooseStartDate() {
        ...
        datePickerDialog = new DatePickerDialog(SmokingInfoActivity.this, new DatePickerDialog.OnDateSetListener() {
            @Override
    ...
    private void setGoal() {
        ...
        Intent intent = new Intent(getApplicationContext(), SmokingReceiver.class);
